...
class Menu:
    def __init__(self, game):
        ...
        self.host = Button(self.game_ref, None, 0.5,3, [255,0,0], self.game_ref.terminal[50].render("HOST", True, (255,255,255)), oneshot = True, oneshot_func = self.host_game, argument = self.game_ref.own_ip)
        self.join = Button(self.game_ref, None, 3,3, [255,0,0], self.game_ref.terminal[50].render("JOIN", True, (255,255,255)), oneshot = True, oneshot_func = self.join_game, argument = self.ip_box.text)
        self.exit = Button(self.game_ref, None, 3,3, [255,0,0], self.game_ref.terminal[50].render("EXIT", True, (255,255,255)), oneshot = True, oneshot_func = self.kill_network)
